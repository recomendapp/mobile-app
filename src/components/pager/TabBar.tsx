...
export function TabBar({
  ...
  return (
    <View
      testID={testID}
      style={[{ backgroundColor: colors.background}, tw`flex-row`]}
      ...
      {/* </BlockDrawerGesture> */}
      <View style={[{ backgroundColor: colors.border }, styles.outerBottomBorder]} />
    </View>
  )
}
      ...
      <Pressable
        ...
        <Animated.View style={[style, styles.itemInner]}>
          <Text
            ...
            style={[styles.itemText, tw`text-md`, tw`font-semibold`]}
