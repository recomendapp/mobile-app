...
const InputBottomSheet = React.forwardRef<React.ElementRef<typeof BottomSheetTextInput>, TextInputProps>(
  ({ style, placeholderTextColor, ...props }, ref) => {
    const { colors } = useTheme();
    return (
...
InputBottomSheet.displayName = 'InputBottomSheet';

export { Input, InputBottomSheet };
