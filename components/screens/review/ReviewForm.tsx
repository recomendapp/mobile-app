...
import { CoreBridge, PlaceholderBridge, RichText, TenTapStartKit, Toolbar, useEditorBridge } from "@10play/tentap-editor";
...
const ReviewForm = ({
	...
	>
		...
		onFocusChange={(isFocused) => setIsEditorFocused(isFocused)}
